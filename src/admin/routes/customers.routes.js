...
import { adminCustomersListController, adminCustomersExportCsvController } from "../controllers/customers.controller.js";
...
adminCustomersRouter.get(
    "/export/csv",
    validate(adminListCustomersSchema),
    adminCustomersExportCsvController
);